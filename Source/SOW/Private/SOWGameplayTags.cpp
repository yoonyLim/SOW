...
namespace SOWGameplayTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG(Enemy_Status_Buff_Invincible, "Enemy.Status.Buff.Invincible");
	...
	UE_DEFINE_GAMEPLAY_TAG(Turret_Status_Buff_SoulEater, "Turret.Status.Buff.SoulEater");
