...
namespace SOWGameplayTags {
	...
	SOW_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Enemy_Status_Buff_WaveBuff);
	...
	SOW_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Enemy_Status_Buff_Invincible);
	...
	SOW_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Enemy_Status_Debuff_Marking);
	...
	SOW_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Turret_Ability_Continue);
	...
	SOW_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Turret_Status_Buff_Hoppy_Normal);
	SOW_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Turret_Status_Buff_Hoppy_Enhanced);
	...
	SOW_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Turret_Status_Buff_Ember);
	SOW_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Turret_Status_Buff_Ignition);
	SOW_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Turret_Status_Buff_Inferno);
	SOW_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Turret_Status_Buff_Glare);
	SOW_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Turret_Status_Buff_Impatience);
	SOW_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Turret_Status_Buff_SoulEater);

	SOW_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Turret_Status_Debuff_Slow);
	SOW_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Turret_Status_Debuff_Pause);
	...
	SOW_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Turret_Event_Attack_Basic_ADD1);
	SOW_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Turret_Event_Attack_Basic_ADD2);
	SOW_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Turret_Event_Attack_Basic_ADD3);
	SOW_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Turret_Event_Attack_Basic_ADD4);
	SOW_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Turret_Event_Attack_Basic_ADD5);
	...
	SOW_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Turret_Event_TikiSupporting);
	...
	SOW_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Shared_Event_HitReact_ShieldHit);
	...
	SOW_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Shared_SetByCaller_TakeSacrificedStatus);
...
namespace SOWSynergyTags {
	...
	SOW_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Synergy_Nature_VIII);
	...
	// Flame Synergy
	SOW_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Synergy_Flame_II);
	SOW_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Synergy_Flame_IV);
	SOW_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Synergy_Flame_V);
}
