...
#include "TurretShopBox_Tutorial.generated.h"
...
class AWaveGameMode;
class UTurretShopBox;

/**
 * 
 */
UCLASS()
class SOW_API UTurretShopBox_Tutorial : public UUserWidget
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "Turrets")
	TArray<FSummonData> FirstTurretCombination;

	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "Turrets")
	TArray<FSummonData> SecondTurretCombination;

	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "Turrets")
	TArray<FSummonData> ThirdTurretCombination;
...
public:
	...
	void SetTurretByStep(int32 step);
